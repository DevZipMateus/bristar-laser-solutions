      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <motion.div
            ...
            className="bg-primary p-8 md:p-10 rounded-2xl text-primary-foreground"
          >
            <div className="flex items-center gap-4 mb-6">
              <Target className="w-10 h-10" />
              <h3 className="font-display text-2xl font-semibold">Missão</h3>
            </div>
          ...
          <motion.div
            ...
            className="bg-dark p-8 md:p-10 rounded-2xl text-dark-foreground"
          >
            <div className="flex items-center gap-4 mb-6">
